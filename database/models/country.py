...
class RefCountry(Base):
    ...
    country_flag_http = Column(String(255))
    ...
    def __init__(self, country_2did_iso, country_name_iso, country_name_simple, country_2did_soeur, country_3did_iso,
                 country_flag_http, jrc_region, iea_region, is_oecd, is_iea, is_mi, is_eu27, is_tax_haven):
        ...
        self.country_flag_http = country_flag_http
